...
legend('Actual PSF 2','PSF 2 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
...
legend('Actual PSF 3','PSF 3 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
...
legend('Actual PSF 4','PSF 4 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
...
legend('Actual PSF 5','PSF 5 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
...
legend('Actual PSF 6','PSF 6 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
...
legend('Actual PSF 7','PSF 7 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
...
legend('Actual PSF 8','PSF 8 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
...
legend('Actual PSF 9','PSF 9 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
...
legend('Actual PSF 10','PSF 10 WAS Metamodel');
set(gca,'FontWeight','bold','FontSize',12);
grid on
