function [Psf,Pf,Re,b]= mcspsfconstraint3c(xmin,lbx,ubx,sd,Nmcs,Pftarget)
...
t0 = [xmin(:,1:16) xmin(:,18)];
sd1 = [sd(1,1:16) sd(1,18)];
lbx1 = [lbx(1,1:16) lbx(1,18)];
ubx1 = [ubx(1,1:16) ubx(1,18)];
Psf = zeros(M,1);
Pf = zeros(M,1);
Re = zeros(M,1);
b = zeros(M,1);
