...
grid on
saveas(h_obj,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Weight_EV_18d.jpg');
% close(h_obj);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_01,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 1_EV_18d.jpg');
% close(h_ls_01);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_02,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 2_EV_18d.jpg');
% close(h_ls_02);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_03,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 03_EV_18d.jpg');
% close(h_ls_03);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_04,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 04_EV_18d.jpg');
% close(h_ls_04);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_05,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 05_EV_18d.jpg');
% close(h_ls_05);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_06,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 06_EV_18d.jpg');
% close(h_ls_06);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_07,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 07_EV_18d.jpg');
% close(h_ls_07);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_08,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 08_EV_18d.jpg');
% close(h_ls_08);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_09,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 09_EV_18d.jpg');
% close(h_ls_09);
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_10,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 10_EV_18d.jpg');
% close(h_ls_10);

%% Constraint 11

[W1star_ls_11_llm,Lstar_ls_11_llm]=subspacevar(b_ls_11_llm,Mboot);
dim_ls_11_llm = [1:1:m_c11]'; 
min_Lstar_ls_11_llm = min(Lstar_ls_11_llm,[],2);
max_Lstar_ls_11_llm = max(Lstar_ls_11_llm,[],2);
x_polyshape_ls_11 = [1:1:m_c11 m_c11:-1:1];
y_polyshape_ls_11 = ([min_Lstar_ls_11_llm' [max_Lstar_ls_11_llm(end:-1:1)]']);

h_ls_11 = figure;
semilogy(dim_ls_11_llm,(diag(Ev_ls_11_llm)),'o-','Color','r','MarkerFaceColor','r','MarkerEdgeColor','k','LineWidth',2);
hold on
patch(x_polyshape_ls_11,abs(y_polyshape_ls_11),'y','EdgeColor','y');
alpha(0.3);
xlabel('Dimensions');
ylabel('Eigenvalues');
% title('Limit State 10 Eigen Value Distribution');
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_11,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 11_EV_18d.jpg');
% close(h_ls_11);

%% Constraint 12

[W1star_ls_12_llm,Lstar_ls_12_llm]=subspacevar(b_ls_12_llm,Mboot);
dim_ls_12_llm = [1:1:m_c12]'; 
min_Lstar_ls_12_llm = min(Lstar_ls_12_llm,[],2);
max_Lstar_ls_12_llm = max(Lstar_ls_12_llm,[],2);
x_polyshape_ls_12 = [1:1:m_c12 m_c12:-1:1];
y_polyshape_ls_12 = ([min_Lstar_ls_12_llm' [max_Lstar_ls_12_llm(end:-1:1)]']);

h_ls_12 = figure;
semilogy(dim_ls_12_llm,(diag(Ev_ls_12_llm)),'o-','Color','r','MarkerFaceColor','r','MarkerEdgeColor','k','LineWidth',2);
hold on
patch(x_polyshape_ls_12,abs(y_polyshape_ls_12),'y','EdgeColor','y');
alpha(0.3);
xlabel('Dimensions');
ylabel('Eigenvalues');
% title('Limit State 10 Eigen Value Distribution');
...
set(gca,'FontWeight','bold','FontSize',12);
grid on
saveas(h_ls_12,'D:\MS Thesis\18 d no dummy variables\All Surrogate Performance\Journal Figures\Eigen Values\Limit State 12_EV_18d.jpg');
% close(h_ls_12);
