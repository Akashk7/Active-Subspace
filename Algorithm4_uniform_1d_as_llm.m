...
% [srgt_RBF_ls_01, PRESSRMS_RBF_ls_01, eXV_RBF_ls_01, srgtOPT_RBF_ls_01, Y_hat_RBF_ls_01, R2_pred_RBF_ls_01] = metamodel_RBF(x_c01,y_ls_01);
% [srgt_KRG_ls_01, PRESSRMS_KRG_ls_01, eXV_KRG_ls_01, srgtOPT_KRG_ls_01, Y_hat_KRG_ls_01, pred_var_KRG_ls_01, R2_pred_KRG_ls_01] = metamodel_KRG(x_c01,y_ls_01);
% [srgt_PRS_ls_01, PRESSRMS_PRS_ls_01, eXV_PRS_ls_01, srgtOPT_PRS_ls_01, Y_hat_PRS_ls_01, pred_var_PRS_ls_01, R2_pred_PRS_ls_01] = metamodel_PRS(x_c01,y_ls_01);
% [srgt_WAS_ls_01, PRESSRMS_WAS_ls_01, eXV_WAS_ls_01, srgtOPT_WAS_ls_01, Y_hat_WAS_ls_01, pred_var_WAS_ls_01, R2_pred_WAS_ls_01] = metamodel_WAS(x_c01,y_ls_01);
...
[b_ls_01_llm,C_ls_01_llm,W_ls_01_llm,Ev_ls_01_llm,avg_r2_pred_ls_01_llm]=llm(x_c01,y_ls_01,M_ls_01,p_ls_01);
...
% % Limit State and PSF Visualization in One dimension
% figure;
% plot(t1_ls_01,y_ls_01,'ro');
% hold on
% plot(t1_c01, y_c01,'bo');
% xlabel('Active Variable for limit state 1');
% ylabel('Function');
% title('Sufficiency Summary Plot');
% legend('Limit State 1','PSF 1');
...
%Build the metamodel in active subspace of Limit State
% [srgt_RBF_ls_02, PRESSRMS_RBF_ls_02, eXV_RBF_ls_02, srgtOPT_RBF_ls_02, Y_hat_RBF_ls_02, R2_pred_RBF_ls_02] = metamodel_RBF(x_c02,y_ls_02);
% [srgt_KRG_ls_02, PRESSRMS_KRG_ls_02, eXV_KRG_ls_02, srgtOPT_KRG_ls_02, Y_hat_KRG_ls_02, pred_var_KRG_ls_02, R2_pred_KRG_ls_02] = metamodel_KRG(x_c02,y_ls_02);
% [srgt_PRS_ls_02, PRESSRMS_PRS_ls_02, eXV_PRS_ls_02, srgtOPT_PRS_ls_02, Y_hat_PRS_ls_02, pred_var_PRS_ls_02, R2_pred_PRS_ls_02] = metamodel_PRS(x_c02,y_ls_02);
% [srgt_WAS_ls_02, PRESSRMS_WAS_ls_02, eXV_WAS_ls_02, srgtOPT_WAS_ls_02, Y_hat_WAS_ls_02, pred_var_WAS_ls_02, R2_pred_WAS_ls_02] = metamodel_WAS(x_c02,y_ls_02);
...
[b_ls_02_llm,C_ls_02_llm,W_ls_02_llm,Ev_ls_02_llm]=llm(x_c02,y_ls_02,M_ls_02,p_ls_02);
...
% Limit State Visualization in One dimension
% figure;
% plot(t1_ls_02,y_ls_02,'ro');
% hold on
% plot(t1_c02,y_c02,'bo');
% xlabel('Active Variable for limit state 1');
% ylabel('Function');
% title('Sufficiency Summary Plot');
% legend('Limit State 2','PSF 2');
...
%Build the metamodel in active subspace of Limit State
% [srgt_RBF_ls_03, PRESSRMS_RBF_ls_03, eXV_RBF_ls_03, srgtOPT_RBF_ls_03, Y_hat_RBF_ls_03, R2_pred_RBF_ls_03] = metamodel_RBF(x_c03,y_ls_03);
% [srgt_KRG_ls_03, PRESSRMS_KRG_ls_03, eXV_KRG_ls_03, srgtOPT_KRG_ls_03, Y_hat_KRG_ls_03, pred_var_KRG_ls_03, R2_pred_KRG_ls_03] = metamodel_KRG(x_c03,y_ls_03);
% [srgt_PRS_ls_03, PRESSRMS_PRS_ls_03, eXV_PRS_ls_03, srgtOPT_PRS_ls_03, Y_hat_PRS_ls_03, pred_var_PRS_ls_03, R2_pred_PRS_ls_03] = metamodel_PRS(x_c03,y_ls_03);
% [srgt_WAS_ls_03, PRESSRMS_WAS_ls_03, eXV_WAS_ls_03, srgtOPT_WAS_ls_03, Y_hat_WAS_ls_03, pred_var_WAS_ls_03, R2_pred_WAS_ls_03] = metamodel_WAS(x_c03,y_ls_03);
...
[b_ls_03_llm,C_ls_03_llm,W_ls_03_llm,Ev_ls_03_llm]=llm(x_c03,y_ls_03,M_ls_03,p_ls_03);
...
% % Limit State Visualization in One dimension
% figure;
% plot(t1_ls_03,y_ls_03,'ro');
% hold on
% plot(t1_c03,y_c03,'bo');
% xlabel('Active Variable for limit state 1');
% ylabel('Function');
% title('Sufficiency Summary Plot');
% legend('Limit State 3','PSF 3');
...
[b_obj_llm,C_obj_llm,W_obj_llm,Ev_obj_llm]=llm(x_obj,y_obj,M_obj,p_obj);
...
% % Limit State Visualization in One dimension
% figure;
% plot(t1_obj,y_obj,'ro');
% hold on
% plot(t1_obj_1,y_obj_1,'bo');
% xlabel('Active Variable for Objective Function');
% ylabel('Function');
% title('Sufficiency Summary Plot');
% legend('Objective Function Original Space','Objective Function Active Space');
